...
for j in range(250,500,25):
	size = str(j)
	os.system("python cmine_new.py 0.065 0.5 0.6 ../dataset/bmspos/bmspos_"+size+"K.txt bmspos_final_"+size+"K.txt ./ bmspos")
...
for j in range(10,100,10):
	maxOR = str(j/100.0)
	os.system("python cmine_new.py 0.065 0.5 "+maxOR+" ../dataset/bmspos/bmspos_325K.txt bmspos_final_325K.txt ./ bmspos")
...
for j in range(65,96,5):
	minRF = str(j/1000.0)
	os.system("python cmine_new.py "+minRF+" 0.5 0.6 ../dataset/bmspos/bmspos_325K.txt bmspos_final_325K.txt ./ bmspos")
...
for j in range(5,51,5):
	maxOR = str(j/100.0)
	os.system("python cmine_new.py 0.035 0.5 "+maxOR+" ../dataset/cabs120k08/cabs120k08_250K.txt cabs120k08_final_250K.txt ./ cabs120k08")
...
for j in range(35,61,5):
	minRF = str(j/1000.0)
	os.system("python cmine_new.py "+minRF+" 0.5 0.4 ../dataset/cabs120k08/cabs120k08_250K.txt cabs120k08_final_250K.txt ./ cabs120k08")

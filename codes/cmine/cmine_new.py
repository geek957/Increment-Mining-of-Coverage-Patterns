...
filepath = sys.argv[6]
data = sys.argv[7]
outfile = filepath+"./outputs/"+data+"/"+splitted[2]+"_"+str(minRF)+"_"+str(minCS)+"_"+str(maxOR)+"_"+sys.argv[5]
print "minRF:",minRF,"minCS:",minCS,"maxOR:",maxOR,"outfile",outfile
...
excel = open(filepath+"./times_final_"+data+".csv",'a')

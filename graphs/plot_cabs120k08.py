...
def plot2(minRF):
	...
	filename = "images_final/cabs120k08_maxOR.eps"
	plot_graph(x_plt, y_plt, X_plt, x_ticks, y_ticks, title, x_label, y_label, legends, [0,50], [0,15], filename,2)
...
def plot3(minRF):
	...
	y_label = "ET ("+r'$ \times 10^2$'+")"
	legends = ('CMine','IncCMine')
	filename = "images_final/cabs120k08_increment.eps"
	plot_graph(x_plt, y_plt, X_plt, x_ticks, y_ticks, title, x_label, y_label, legends, [0,100], [0, 16], filename, 1)

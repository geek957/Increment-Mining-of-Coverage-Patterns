...
def plot2(minRF):
	...
	filename = "images_final/synthetic_maxOR.eps"
...
def plot3(minRF):
	...
	y_label = "ET ("+r'$ \times 10^2$'+")"
	legends = ('CMine','IncCMine')
	filename = "images_final/synthetic_increment.eps"
	plot_graph(x_plt, y_plt, X_plt, x_ticks, y_ticks, title, x_label, y_label, legends, [0,50], [0, 11], filename, 1)

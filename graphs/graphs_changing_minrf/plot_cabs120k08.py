...
def plot1():
	...
	filename = "../images_final/cabs120k08_minRF.eps"
	plot_graph1(x_plt, y_plt, X_plt, x_ticks, y_ticks, title, x_label, y_label, legends,[0.0,5], [33,60], [0,15], filename, 1)

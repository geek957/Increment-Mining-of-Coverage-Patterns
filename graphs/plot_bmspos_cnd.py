...
def plot2(minRF):
	...
	filename = "images_final/bmspos_cnd_maxOR.eps"
	plot_graph(x_plt, y_plt, X_plt, x_ticks, y_ticks, title, x_label, y_label, legends, [0,90], [0,100], filename, 2)
...
def plot3(minRF):
	...
	y_label = "NC ("+r'$ \times 10^3$'+")"
	legends = ('CMine','IncCMine')
	filename = "images_final/bmspos_cnd_increment.eps"
	plot_graph(x_plt, y_plt, X_plt, x_ticks, y_ticks, title, x_label, y_label, legends, [0,100], [0, 30], filename, 1)
